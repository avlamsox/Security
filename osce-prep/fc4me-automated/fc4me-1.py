#FC4.me Challenge-1 Automated Completely(May not be optimized code - but it works)
#Do not use this Challenge to Cheat for Stage 1
#However, you can use this to get required Stuff faster for Challenge 2
#
#
import requests
import base64
...
def generate32BitAssembly(raw_shellcode):
	...
	print "The Actual Shellcode For Disassembly is ---- %s ---" % xcode
